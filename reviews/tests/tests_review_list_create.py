...
class ReviewListCreateAPITestCase(APITestCase):
    ...
    def test_create_review_valid_response_structure(self):
        """Test that the response data structure when creating a review contains the expected fields"""
    ...
    def test_create_review_user_has_already_reviewed_returns_400(self):
        """Test that creating a review for the same business user by the same customer returns a 400 response"""
...
class ReviewListAPITestCase(APITestCase):
    ...
    def test_get_reviews_as_unauthenticated_user_returns_401(self):
        """Test that a GET request to the reviews endpoint without authentication returns a 401 response"""

        response = self.client.get(self.url)
        self.assertEqual(response.status_code, http_status.HTTP_401_UNAUTHORIZED)

    def test_get_reviews_with_business_user_filter_returns_200(self):
        """Test that filtering reviews by business user returns a 200 response and the correct number of reviews"""
    ...
    def test_get_reviews_with_reviewer_filter_returns_200(self):
        """Test that filtering reviews by reviewer returns a 200 response and the correct number of reviews"""
    ...
    def test_get_reviews_with_ordering_to_updated_at_returns_200(self):
        """Test that ordering reviews by updated_at returns a 200 response and the correct number of reviews"""
    ...
    def test_get_reviews_with_ordering_to_rating_returns_200(self):
        """Test that ordering reviews by rating returns a 200 response and the correct number of reviews"""
